...
class DocumentaryFilmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documentary_film" do
    assert_difference("DocumentaryFilm.count") do
      post documentary_films_url, params: { documentary_film: { director: @documentary_film.director, name: @documentary_film.name, sypnosis: @documentary_film.sypnosis } }
    end
  ...
  test "should update documentary_film" do
    patch documentary_film_url(@documentary_film), params: { documentary_film: { director: @documentary_film.director, name: @documentary_film.name, sypnosis: @documentary_film.sypnosis } }
