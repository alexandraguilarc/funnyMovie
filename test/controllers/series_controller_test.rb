...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Serie.count") do
      post series_url, params: { series: { director: @series.director, name: @series.name, sypnosis: @series.sypnosis } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { director: @series.director, name: @series.name, sypnosis: @series.sypnosis } }
