class SeriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @series.save
        format.html { redirect_to series_url(@series), notice: "Serie was successfully created." }
  ...
  def update
    respond_to do |format|
      if @series.update(series_params)
        format.html { redirect_to series_url(@series), notice: "Serie was successfully updated." }
  ...
  private
    ...
    def series_params
      params.require(:series).permit(:name, :sypnosis, :director)
    end
end
